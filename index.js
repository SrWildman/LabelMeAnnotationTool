        ...
        $.ajax({
          ...
          success: (data) => {
            ...
            $(data).find("a").filter(function(){
              ...
              $('<div class="gallery_product col-lg-3 col-md-4 col-sm-4 col-xs-6 filter ' + folder +'"></div>').html('<a href="'+ 'AnnotationTool/tool.html?actions=a&mode=f&showimgname=true&folder='+folder+'&image='+image+'" class="'+image+'"></a>').appendTo('.row')
